...
The current build covers M1–M2: a unified alarm, idle-aware scheduling, popup controls (an adjustable break rhythm of 20 or 30 minutes, focus for 1 hour, turn reminders off indefinitely, EN/TH language switch), the full escalating-ghost interaction (peek → float out → nap on your cursor, with its own "5 more minutes" snooze on the ghost itself), and the big-break overlay with guided TH/EN stretch instructions. There are no accounts, servers, analytics, or tracking.